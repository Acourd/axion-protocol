...
2. **Deterministic TDD & 100% Green Suite:**
   - Redact test assertions in `tests/` *before* modifying code. All 242 deterministic suites across all 5 governance domains must pass with `exit code 0`.
...
- [ ] All 242 test suites pass with Exit Code 0.
