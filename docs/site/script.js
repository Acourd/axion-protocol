...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const I18N = {
    en: {
      ...
      statusPill: 'v1.4.0-beta.1 · 244 Suites',
      navHero: 'Home',
    ...
    scopeBanner: 'Scope: experimental local governance toolkit. Local identity and signatures; no process isolation; no certification. Swarm and BFT are diagnostic simulations.',
      ...
      step06Name: 'AUDIT',
      step06Desc: 'Runs the full 244 automated test suites, performs strict VibeGuard anti-pattern scans, and validates exit code 0.',
      step07Name: 'PROMOTE',
      ...
      chipAllDomains: 'All Domains (244)',
      ...
      breakdownTitle: 'Distribution of the 244 Suites',
    ...
    scopeBanner: 'Alcance: toolkit experimental de gobernanza local. Identidad y firma locales; sin aislamiento de proceso; sin certificación. Swarm y BFT son simulaciones de diagnóstico.',
      ...
      step06Name: 'AUDITAR',
      step06Desc: 'Ejecución real de la suite de 244 pruebas, escaneo VibeGuard de antipatrones y validación de salida con exit code 0.',
      step07Name: 'PROMOVER',
      ...
      chipAllDomains: 'Todos los Dominios (244)',
      ...
      breakdownTitle: 'Distribución de las 244 Suites',
  ...
  function executeSimulatorCommand(cmd) {
    ...
    if (clean === '/drive') {
      ...
      playSuccessChime();
      appendTerminalLinesStaggered([
        { type: 'info', text: '[/verify] Ejecutando suite de 244 pruebas deterministas en 8 workers...' },
        { type: 'pass', text: '✓ [simulación] 244 suites · este panel no ejecuta la suite' }
      ]);
