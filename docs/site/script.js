...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const I18N = {
    en: {
      ...
      statusPill: 'v1.4.0-beta.1 · 239 Suites',
      navHero: 'Home',
      ...
      step06Name: 'AUDIT',
      step06Desc: 'Runs the full 239 automated test suites, performs strict VibeGuard anti-pattern scans, and validates exit code 0.',
      step07Name: 'PROMOTE',
      ...
      chipAllDomains: 'All Domains (239)',
      ...
      breakdownTitle: 'Distribution of the 239 Suites',
    ...
    es: {
      ...
      step06Name: 'AUDITAR',
      step06Desc: 'Ejecución real de la suite de 239 pruebas, escaneo VibeGuard de antipatrones y validación de salida con exit code 0.',
      step07Name: 'PROMOVER',
      ...
      chipAllDomains: 'Todos los Dominios (239)',
      ...
      breakdownTitle: 'Distribución de las 239 Suites',
  ...
  function executeSimulatorCommand(cmd) {
    ...
    if (clean === '/drive') {
      ...
      playSuccessChime();
      appendTerminalLinesStaggered([
        { type: 'info', text: '[/verify] Ejecutando suite de 239 pruebas deterministas en 8 workers...' },
        { type: 'pass', text: '✓ [simulación] 239 suites · este panel no ejecuta la suite' }
      ]);
