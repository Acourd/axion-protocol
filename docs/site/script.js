...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const I18N = {
    en: {
      ...
      statusPill: 'v1.4.0-beta.1 · 240 Suites',
      navHero: 'Home',
      ...
      step06Name: 'AUDIT',
      step06Desc: 'Runs the full 240 automated test suites, performs strict VibeGuard anti-pattern scans, and validates exit code 0.',
      step07Name: 'PROMOTE',
      ...
      chipAllDomains: 'All Domains (240)',
      ...
      breakdownTitle: 'Distribution of the 240 Suites',
    ...
    es: {
      ...
      step06Name: 'AUDITAR',
      step06Desc: 'Ejecución real de la suite de 240 pruebas, escaneo VibeGuard de antipatrones y validación de salida con exit code 0.',
      step07Name: 'PROMOVER',
      ...
      chipAllDomains: 'Todos los Dominios (240)',
      ...
      breakdownTitle: 'Distribución de las 240 Suites',
  ...
  function executeSimulatorCommand(cmd) {
    ...
    if (clean === '/drive') {
      ...
      playSuccessChime();
      appendTerminalLinesStaggered([
        { type: 'info', text: '[/verify] Ejecutando suite de 240 pruebas deterministas en 8 workers...' },
        { type: 'pass', text: '✓ [simulación] 240 suites · este panel no ejecuta la suite' }
      ]);
