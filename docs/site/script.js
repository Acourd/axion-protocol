...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const I18N = {
    en: {
      ...
      statusPill: 'v1.2.0-beta.1 · 192 Suites PASS',
      ...
      statSuites: '<strong>192/192</strong> suites PASS',
      ...
      phases: {
        ...
        '06': { name: 'AUDIT', title: 'Phase 06: AUDIT', desc: 'Executes 192 automated test suites, VibeGuard quality gate, and verifies the SHA-256 evidence manifest.' },
    ...
    es: {
      ...
      phases: {
        ...
        '06': { name: 'AUDITAR', title: 'Fase 06: AUDITAR', desc: 'Ejecuta 192 suites de prueba automáticas, VibeGuard strict y comprueba el sello de evidencia SHA-256.' },
