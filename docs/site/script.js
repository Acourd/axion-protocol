...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const I18N = {
    en: {
      ...
      statusPill: 'v1.2.0-beta.1 · 42 Suites PASS',
      ...
      statSuites: '<strong>42/42</strong> suites PASS',
      statCmds: '<strong>14</strong> slash commands',
      ...
      phases: {
        ...
        '06': { name: 'AUDIT', title: 'Phase 06: AUDIT', desc: 'Executes 42 automated test suites, VibeGuard quality gate, and verifies the SHA-256 evidence manifest.' },
      ...
      bento5Desc: 'Built exclusively with native Node.js built-ins (fs, crypto, path, child_process). No Docker containers or heavy packages.',
      ...
      cmdBadge: 'Ergonomics',
      cmdTitle: '14 Universal Slash Commands',
    ...
    es: {
      ...
      phases: {
        ...
        '06': { name: 'AUDITAR', title: 'Fase 06: AUDITAR', desc: 'Ejecuta 42 suites de prueba automáticas, VibeGuard gate y comprueba el sello de evidencia SHA-256.' },
      ...
      cmdBadge: 'Ergonomía',
      cmdTitle: '14 Slash Commands Universales',
