...
## Enforcement de enforcement actual
...
Las pruebas heredadas viven en `tests/` y `tests/regression/`. Las pruebas de seguridad de enforcement actual viven en `tests/runtime_security/` y no ejecutan comandos destructivos reales.
