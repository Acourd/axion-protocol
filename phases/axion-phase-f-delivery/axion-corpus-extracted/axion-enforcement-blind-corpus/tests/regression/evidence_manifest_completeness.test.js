/**
 * Prueba: El manifiesto de evidencia debe ser completo, no autoaprobado
...
console.log('PASS evidence manifest completeness — manifiesto conforme al esquema, completo y sin autoaprobación');
