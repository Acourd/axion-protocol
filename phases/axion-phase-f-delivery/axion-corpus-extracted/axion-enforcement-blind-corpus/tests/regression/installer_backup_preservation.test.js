/**
 * Prueba: El instalador no debe destruir configuración preexistente.
...
const destino = fs.mkdtempSync(path.join(os.tmpdir(), 'ax-f-001-'));
...
console.log('PASS installer backup preservation — configuración preexistente respaldada y recuperable');
