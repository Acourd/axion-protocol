/**
 * Prueba: Un fallo de escritura jamás puede truncar la memoria durable.
...
const dir = fs.mkdtempSync(path.join(os.tmpdir(), 'ax-f-006-'));
...
console.log('PASS learning history preservation — historial preservado ante fallo de escritura y error propagado');
