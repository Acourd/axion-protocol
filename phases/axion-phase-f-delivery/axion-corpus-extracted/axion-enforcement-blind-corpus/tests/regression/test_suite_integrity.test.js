/**
 * Prueba: Integridad de la propia suite de pruebas.
...
console.log(`PASS test suite integrity — ${todos.length} pruebas documentadas, 0 imports rotos, 0 tautologías, 0 mensajes falsos`);
