...
El runtime local aplica los controles de riesgo, aprobacion, CHECK, comando estructurado y evidencia descritos en `SECURITY.md` cuando el consumidor invoca `tools/workflow_runner.js`. No existe interceptacion global ni runtime certificado; el resto de controles conserva alcance documental.
