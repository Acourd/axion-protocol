...
function verifyIndependentCheck({ envelope, expectedBinding, registryPath, executorActorId, approvalActorId, now = new Date() }) {
  ...
  if (typeof executorActorId !== 'string' || executorActorId.trim() === ''
      || typeof approvalActorId !== 'string' || approvalActorId.trim() === '') {
