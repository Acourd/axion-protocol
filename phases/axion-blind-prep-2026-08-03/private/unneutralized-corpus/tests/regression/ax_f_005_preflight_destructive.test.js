/**
 * Regresión AX-F-005 — La barrera destructiva debe detener las formas equivalentes,
...
// Las 15 filas destructivas de la tabla de evidencia de AX-F-005.
...
console.log(`PASS AX-F-005 — ${DEBEN_DETENERSE.length} destructivos detenidos, ${DEBEN_PASAR.length} legítimos permitidos`);
