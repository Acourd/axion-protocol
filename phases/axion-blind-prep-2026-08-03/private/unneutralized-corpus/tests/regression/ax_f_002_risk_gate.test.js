/**
 * Regresión AX-F-002 — El gate de aprobación humana debe fallar cerrado.
...
console.log(`PASS AX-F-002 — ${EXIGEN_GATE.length} grafías exigen gate, ${FUERA_DE_DOMINIO.length} valores fuera de dominio bloquean`);
