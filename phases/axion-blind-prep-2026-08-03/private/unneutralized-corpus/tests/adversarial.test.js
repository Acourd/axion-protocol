...
assert.strictEqual(runPreflight('').status, 'STOP');
assert.strictEqual(runPreflight(null).status, 'STOP');
assert.strictEqual(runPreflight('git status').status, 'PASS');
assert.strictEqual(runPreflight('rm -rf /').status, 'STOP');
assert.strictEqual(runPreflight('git commit -m "unclosed string').status, 'STOP');
