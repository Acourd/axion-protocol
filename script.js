...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const I18N = {
    en: {
      ...
      statusPill: 'v1.2.0-beta.1 · 47 Suites PASS',
      ...
      statSuites: '<strong>47/47</strong> suites PASS',
      statCmds: '<strong>15</strong> slash commands',
      ...
      phases: {
        ...
        '06': { name: 'AUDIT', title: 'Phase 06: AUDIT', desc: 'Executes 47 automated test suites, VibeGuard quality gate, and verifies the SHA-256 evidence manifest.' },
      ...
      cmdBadge: 'Ergonomics',
      cmdTitle: '15 Universal Slash Commands',
    ...
    es: {
      ...
      phases: {
        ...
        '06': { name: 'AUDITAR', title: 'Fase 06: AUDITAR', desc: 'Ejecuta 47 suites de prueba automáticas, VibeGuard gate y comprueba el sello de evidencia SHA-256.' },
      ...
      cmdBadge: 'Ergonomía',
      cmdTitle: '15 Slash Commands Universales',
