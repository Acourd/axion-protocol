...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const I18N = {
    en: {
      ...
      statusPill: 'v1.2.0-beta.1 · 60 Suites PASS',
      ...
      statSuites: '<strong>60/60</strong> suites PASS',
      ...
      phases: {
        ...
        '06': { name: 'AUDIT', title: 'Phase 06: AUDIT', desc: 'Executes 60 automated test suites, VibeGuard quality gate, and verifies the SHA-256 evidence manifest.' },
    ...
    es: {
      ...
      phases: {
        ...
        '06': { name: 'AUDITAR', title: 'Fase 06: AUDITAR', desc: 'Ejecuta 60 suites de prueba automáticas, VibeGuard gate y comprueba el sello de evidencia SHA-256.' },
