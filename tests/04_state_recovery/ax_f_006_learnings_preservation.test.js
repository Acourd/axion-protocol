/**
 * Regresión AX-F-006 — Un fallo de escritura jamás puede truncar la memoria durable.
...
console.log('PASS AX-F-006 — historial preservado ante fallo de escritura y error propagado');
