/**
 * Regresión AX-F-004 — El manifiesto de evidencia debe ser completo, no autoaprobado
...
console.log('PASS AX-F-004 — manifiesto conforme al esquema, completo y sin autoaprobación');
