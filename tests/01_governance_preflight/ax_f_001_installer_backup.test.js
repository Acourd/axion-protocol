/**
 * Regresión AX-F-001 — El instalador no debe destruir configuración preexistente.
...
console.log('PASS AX-F-001 — configuración preexistente respaldada y recuperable');
