...
[![CI Status](https://img.shields.io/badge/CI-240%20Suites-informational.svg?style=flat-square)](https://github.com/Acourd/axion-protocol/actions)
...
| :--- | :--- | :---: |
| 🛡️ **Governance & Preflight** | PreToolUse hooks, lexical preflight, killswitch, risk policy compiler, structured commands, workflow state machine, drive engine | 146 |
| 🔐 **Cryptography & Attestation** | DSSE/PAE envelopes, RFC 8785 canonical JSON, in-toto Statement v1, Ed25519 signatures, evidence binding, revocation | 30 |
...
**Total: 240 suites** across the 5 governance domains. CI publishes the verified result.
