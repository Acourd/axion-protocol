...
Axion Protocol includes **52 deterministic test suites** out of the box with zero external dependencies:

```bash
# Run all 52 test suites
node tests/run_all.js
```

<details>
<summary><strong>📋 View all 52 Test Suites Included</strong></summary>
