...
[![CI Status](https://img.shields.io/badge/CI-246%20Suites-informational.svg?style=flat-square)](https://github.com/Acourd/axion-protocol/actions)
...
Axion Protocol includes **246 deterministic test suites** that run concurrently with zero external test runners:
...
| 🔐 **Cryptography & Attestation** | DSSE/PAE envelopes, RFC 8785 canonical JSON, in-toto Statement v1, Ed25519 signatures, evidence binding, revocation | 33 |
...
| ⚡ **Adversarial Resilience** | Mutation vectors, pre-mortem verdict derivation, VibeGuard lexical gate, boilerplate detection, fuzzer burst resilience | 19 |

**Total: 246 suites** across the 5 governance domains. CI publishes the verified result.
