...
Axion Protocol includes **53 deterministic test suites** out of the box with zero external dependencies:

```bash
# Run all 53 test suites
node tests/run_all.js
```

<details>
<summary><strong>📋 View all 53 Test Suites Included</strong></summary>
