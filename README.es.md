...
[![Estado de CI](https://img.shields.io/badge/CI-243%20Suites-informational.svg?style=flat-square)](https://github.com/Acourd/axion-protocol/actions)
...
Axion Protocol incluye **243 suites de prueba deterministas** que se ejecutan concurrentemente sin dependencias externas:

```bash
# Ejecutar las 243 suites de prueba
npm test
```
