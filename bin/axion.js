...
const SUBCOMANDOS = {
  ...
  compliance: { script: 'tools/compliance_matrix_exporter.js', ayuda: 'exporta la autoevaluación de conformidad (sin certificación SLSA) contra in-toto y NIST SSDF' },
  ...
  'auto-compact': { script: 'tools/auto_compacting_checkpoint.js', ayuda: 'auto-compactación y poda en caliente de checkpoints y estados' },
  ...
  'swarm-ast': { script: 'tools/swarm_ast_arbiter.js', ayuda: 'bloqueo atómico AST multi-agente y arbitraje de colisiones concurrentes' },
